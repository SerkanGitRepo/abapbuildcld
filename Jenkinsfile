...
//	}
	...
	stage ('Acceptance') {
		...
		publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: "/serenity", reportFiles: "index.html", reportName: "HTML Report", reportTitles: "Test Raporu"])
